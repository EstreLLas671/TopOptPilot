...
import { FileJson2, Play, Send, Square, Terminal } from "lucide-react";
import type { EngineeringRun } from "../../types";

type BottomTab = "terminal" | "log" | "output" | "tools" | "artifacts" | "diagnostics";
...
export default function EngineeringBottomPanel(props: Props) {
  const {
    ...
    matlabDiagnostic, runtimeDiagnostic,
    onTerminalCommandChange, onStartTerminal, onStopTerminal,

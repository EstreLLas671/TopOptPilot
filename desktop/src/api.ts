...
export const api = {
  ...
  researchFidelityStageDecision: (id: string, action: "REPEAT_STAGE" | "ADVANCE_STAGE" | "APPROVE_FINAL") => request<Research>(`/api/research/${encodeURIComponent(id)}/fidelity-stage-decision`, { method: "POST", body: JSON.stringify({ action }) }),

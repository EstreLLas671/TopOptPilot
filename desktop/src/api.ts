...
export const api = {
  ...
  autonomous: (id: string, options: { resume?: boolean } = {}) => request<Research>(`/api/research/${encodeURIComponent(id)}/autonomous`, { method: "POST", body: JSON.stringify(options) }),
  resetResearchExecution: (id: string) => request<Research>(`/api/research/${encodeURIComponent(id)}/reset-execution`, { method: "POST" }),

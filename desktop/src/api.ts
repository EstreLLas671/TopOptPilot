...
export const api = {
  ...
  researchFidelityStageDecision: (id: string, advance: boolean) => request<Research>(`/api/research/${encodeURIComponent(id)}/fidelity-stage-decision`, { method: "POST", body: JSON.stringify({ advance }) }),

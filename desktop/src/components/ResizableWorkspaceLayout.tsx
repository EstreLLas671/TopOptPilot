...
export default function ResizableWorkspaceLayout({ mode, left, leftHeader, leftRail, center, right, bottom, activitySignal = "", completionSignal = "" }: Props) {
  ...
  >
    ...
    {layout.rightOpen ? <aside className="v2-inspector workspace-panel workspace-right" data-panel="right"><div className="workspace-panel-content">{right}</div></aside> : null}
